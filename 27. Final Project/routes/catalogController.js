...
let { getItems, getItem } = require("../utility/itemDB");
let { categories, getAllCategories } = require("../utility/categories");
...
router.get("/categories", async (req, res) => {
  ...
  await getItems().then(async itemList => {
...
// **********************************ITEM**********************************
router.get("/categories/item/:itemID", [check("itemID")], async (req, res) => {
  ...
  await getItem(req.params.itemID).then(item => {
