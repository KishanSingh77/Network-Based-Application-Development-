...
const { categories, getAllCategories } = require("../utility/categories");
...
router.get("/addProduct", (req, res) => {
  res.render("addProduct", { user: req.session.theUser });
});
